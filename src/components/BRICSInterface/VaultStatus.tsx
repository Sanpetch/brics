    ...
    <div className="bg-white p-6 rounded-lg shadow-sm">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          <span className="text-gray-600">BRICS on VALUT</span>
          <span className="font-semibold">3.55B BRICS</span>
        </div>

        <div className="flex justify-between items-center">
          <span className="text-gray-600">CNY Deposit</span>
          <span className="font-semibold">xxxx Tokens</span>
        </div>

        <div className="flex justify-between items-center">
          <span className="text-gray-600">RUB Deposit</span>
          <span className="font-semibold">xxxx Tokens</span>
        </div>

        <div className="flex justify-between items-center">
          <span className="text-gray-600">INR Deposit</span>
          <span className="font-semibold">xxxx Tokens</span>
        </div>
